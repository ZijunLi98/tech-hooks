...
import { usePreviousState } from 'techHooks';
...
export default () => {
  ...
  const previousName = usePreviousState(state, nameCompareFunction);
  const previousJob = usePreviousState(state, jobCompareFunction);
